...
// see: https://github.com/bolinfest/alt-esc-prototype/blob/main/src/configuration.ts
import type {LanguageConfiguration} from '@/playground/utils/types-helper'
 ...
 */
export function rehydrateRegexps(rawConfiguration: string): LanguageConfiguration {
